...
namespace OlasilikHesaplama
{
    public partial class Main : Form
    {
        ...
        private void DetectDotnetVersion()
        {
            using (var ndpKey = RegistryKey.OpenBaseKey(RegistryHive.LocalMachine, RegistryView.Registry32).OpenSubKey(_subKey))
            {
                ...
                else
                {
                    ...
                    DialogResult dialogResult = MessageBox.Show("4.8.1 Sürümünü Kurmak İstiyor Musunuz?", "DotNet Kurulumu", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void HataliSoruBildir_Click(object sender, EventArgs e)
        {
            Process.Start("https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSHvnwfdRMHvjLWRgwQsnQtTdMhmsPZrmnWhqTLvRMgGDNqDXgFlNxlszZHxBQqVPCfpfQzg");
        }
